"use strict";
//
// Vendored from `code-push@4.2.3` (https://github.com/microsoft/code-push)
// Copyright (c) Microsoft Corporation. Licensed under the MIT License.
//
// We inline these tiny error classes (and the sibling acquisition-sdk) so that
// this package no longer needs to depend on the `code-push` npm package, which
// drags in deprecated transitive deps (`superagent@5/8`, `formidable@1`).
// Only the acquisition SDK and its error types are used at runtime; the rest
// of `code-push` (CLI, file upload, management SDK) is never imported here.
//
